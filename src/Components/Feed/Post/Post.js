...
const Post = ({profile_pic, username , content,caption , like , comment}) => {
    ...
    <div className='post'>
        <div className="post__header">
            <div className="post__user">
                    {Profilepicshow()}
                <div className="post__user__name">
                        <h4>{username}</h4>
                </div>
            </div>
            <MoreHorizIcon />
        ...
        <div className="post__bottom__option">
            ...
            <div className="post__main__option">
            ...
            <div className="post__other__option">
        ...
        <div className="post__info">
            <div className="post__view__comment">
                <p>{`View all ${comment} Comments `}</p>
            </div>
            <div className="post__view__timestamp">
                <p>2 DAYS AGO</p>
            </div>
        </div>
